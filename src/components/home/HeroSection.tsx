  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Gradient Overlays */}
        <div className="absolute inset-0 bg-gradient-to-r from-mountain-charcoal/90 via-mountain-charcoal/70 to-mountain-charcoal/40" />
        <div className="absolute inset-0 bg-gradient-to-t from-mountain-charcoal/80 via-transparent to-mountain-charcoal/30" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-20">
        <div className="max-w-3xl">
          ...
          {/* Headline */}
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-snow-white leading-[1.1] mb-6 animate-fade-up" style={{ animationDelay: "100ms" }}>
            Colorado's Trusted
            <span className="block text-primary">General Contractor</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-mountain-mist leading-relaxed mb-8 max-w-xl animate-fade-up" style={{ animationDelay: "200ms" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-up" style={{ animationDelay: "300ms" }}>
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className="text-base font-semibold h-14 px-8 border-snow-white/30 text-snow-white hover:bg-snow-white/10 hover:text-snow-white"
            >
          ...
          <div className="flex flex-wrap gap-6 animate-fade-up" style={{ animationDelay: "400ms" }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-mountain-mist">Call Anytime</p>
                <a href="tel:+17201234567" className="text-snow-white font-semibold hover:text-primary transition-colors">
                  (720) XXX-XXXX
                </a>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-mountain-mist">Quick Response</p>
