...
export function GallerySection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-0 md:min-h-screen w-full overflow-hidden"
    >
      ...
      {/* Content */}
      <div className="relative h-auto md:h-screen flex flex-col items-center justify-center py-16 md:py-12 px-4">
        {/* Header */}
